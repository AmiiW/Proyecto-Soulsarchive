...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const habitaciones = [
        ...
        { nombre: 'Arco', probabilidad: 32, arma: 'Arco.png' },
        { nombre: 'CuchilloMariposa', probabilidad: 39, arma: 'Cuchillo mariposa.png' },
        ...
        { nombre: 'Toxico', probabilidad: 21, arma: 'Puño.png', efecto: 'muerte' }, // Nueva habitación
    ...
    const finalizarJuego = () => {
        ...
        alert('¡Has alcanzado el piso final! Enfrentas al jefe final.');

document.addEventListener('DOMContentLoaded', () => {
    ...
    function createCircle() {
        ...
        circle.addEventListener('click', () => {
            ...
            if (clicks === 1 && color !== '#FF0000' && !isVioletOrPink(color) && color !== 'silver') {
                ...
                // Se mueve al segundo clic
                circle.classList.add('shake');
                setTimeout(() => {
                    circle.classList.remove('shake');
                }, 500);
            } else if (clicks === 3 && color !== '#FF0000' && !isVioletOrPink(color) && color !== 'silver') {
                // Daño al enemigo al tercer clic para los que se movieron al primer clic
                enemyHealth -= 5;
                if (enemyHealth < 0) enemyHealth = 0;
                enemyHealthElement.textContent = `Vida: ${enemyHealth}%`;
            } else if (clicks === 4 && color !== '#FF0000' && !isVioletOrPink(color) && color !== 'silver') {
                // 60% de probabilidad de curar al enemigo al cuarto clic
                if (Math.random() < 0.6) {
                    enemyHealth += 7;
                    if (enemyHealth > 100) enemyHealth = 100;
                    enemyHealthElement.textContent = `Vida: ${enemyHealth}%`;
                } else {
                    // Daño al enemigo si no se cura
                    enemyHealth -= 5;
                    if (enemyHealth < 0) enemyHealth = 0;
                    enemyHealthElement.textContent = `Vida: ${enemyHealth}%`;
                }
        ...
        }, isSilverCircle ? 800 : 2100); // Duración menor para el círculo plateado
    }
    ...
    function moveCircle(circle) {
        ...
        circle.style.transition = 'top 0.5s, left 0.5s';
...
function showShop() {
    ...
    shopContainer.innerHTML = `
        ...
        <div class="shop-items">
            ...
            <div class="shop-item" data-price="320" data-text="2039">
                <img src="Obj2.png"" alt="Item 2" class="shop-item-icon">
                <p class="shop-item-description">^.^</p>
                <p class="shop-item-price">Precio: 320</p>
            </div>
            <div class="shop-item" data-price="1999" data-text="8901">
                <img src="Obj3.png"" alt="Item 3" class="shop-item-icon">
                <p class="shop-item-description">...</p>
                <p class="shop-item-price">Precio: 1999</p>
            </div> 
        </div>
...
document.getElementById('enemy-image').addEventListener('click', function() {
    const texts = [
        "...Perderas la cabeza",
        "Hazme setir mejoOoº0r",
        "...",
        "...El sello de fe lucha por mi",
